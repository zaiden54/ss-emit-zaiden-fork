...
export const PartnersCards = () => {
  const PartnersList = [
    { img: topstr, title: "TOPSTRETCHING — международная сеть студий растяжки и фитнеса, предлагающая 3 базовых направления: aerostretching, trx и школа шпагата. Заниматься можно и онлайн, а все локации находятся в шаговой доступности от метро. Скидка 30% всем студентам и преподавателям ЭМИТ." },
    { img: "", title: "" },
    {
      img: pekarnya,
      title:
    ...
    { img: "", title: "" },
    { img: mart, title: "MART — студия художественной вышивки, которая выполняет дизайны любой сложности: от логотипов до картин известных художников! Студия поможет воплотить любую твою задумку. Скидка 15% студентам ЭМИТ." },
    { img: "", title: "" },
    { img: gonchar, title:"Гончар и художник — это творческая студия, предлагающая мастер-классы и индивидуальные занятия за гончарным кругом, по ручной лепке и живописи. Скидка 10% для студентов и сотрудников Академии."},
    { img: "", title: "" },
    { img: "", title: "" },
    { img: planum, title: "Стильные и качественные блокноты подойдут любителям планировать, рисовать или вести записи. Они точно помогут сделать твой день более продуктивным." },
    { img: "", title: "" },
    { img: candles, title: "YAM.CANDLES – бренд натуральных свечей и подсвечников из гипса ручной работы. Изделия из кокосового воска помогут создать уют в твоём доме, сделав вечера максимально комфортными и атмосферными. Каждый подсвечник с неповторимым узором будет идеальным дополнением в твой интерьер. А сами свечи будут приносить тебе тепло и уют!" },
    { img: "", title: "" },
    ...
    { img: shoper, title: "Делаем шоперы из эко-материалов и наносим на них классные рисунки!" },
    { img: "", title: "" },
    { img: "", title: "" },
    { img: printer, title: "Печать моментальных фотографий может стать изюминкой любого мероприятия и запечатлеть миг не только в сердце, но и в твоём фотоальбоме." },
    { img: "", title: "" },
    { img: veco, title: "Мы занимаемся репродукцией и отчистки природы в повседневных вещах. Унас есть качественная продукция из эко-материалов" },
